...
namespace Testing
{
    ...
    public class UnitTest1
    {
        ...
        public void Setup()
        {
            ...
            Potrebitel user = new Potrebitel(0, "Svetoslav", "Bonchev", 13, "kostenurka", "112233", "poshta@gmail.com", 0);
            ElUsero = user;
        }
        [TestCleanup]
        public void CleanUp()
        ...
        {
            var newuser = new Potrebitel(0, "Svetoslav", "Bonchev", 13, "kostenurka", "112233", "poshta@gmail.com", 0);
            context.Update(newuser);

            Assert.AreEqual("Svetoslav", context.Read(0).Name);
        }
        [TestMethod]
